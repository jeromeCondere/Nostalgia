...
public class NetlogoRunner extends GraphicModelRunner implements Cloneable  {
	...
	//this version wait for the command to be completed
	...
	//this version does not wait for the command to be completed
	public void NetlogoCmdLater(String cmd)
	{
		try {
			comp.command (cmd);
		}
